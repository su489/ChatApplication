    ...
    return (
        <>
            <div className='flex h-screen items-center justify-center'>
                <form onSubmit={handleSubmit(onSubmit)} className='border boder-white px-6 py-2 rounded-md space-y-3 w-90'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <input type="submit" value="Login" className='text-white bg-green-500 px-4 py-1 cursor-pointer rounded-lg' />
                    </div>
